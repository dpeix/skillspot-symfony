...
{
    #[Route(path: ['fr' => '/fr/admin/demandes-organisateur', 'en' => '/en/admin/organizer-applications'], name: 'admin_organizer_applications', methods: ['GET'])]
    ...
    #[Route(path: ['fr' => '/fr/admin/demandes-organisateur/{id<\d+>}/{decision}', 'en' => '/en/admin/organizer-applications/{id<\d+>}/{decision}'], name: 'admin_organizer_application_review', requirements: ['decision' => 'approve|reject'], methods: ['POST'])]
    public function review(
        ...
        try {
            ...
            $this->addFlash('success', 'admin.organizer_application.flash.reviewed');
